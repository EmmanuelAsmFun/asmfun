...
import { UIDataNameAvatar } from "./AvatarFactory.js";
...
export class AvatarManager implements IAvatarContext{
    ...
    constructor(mainData: IMainData) {
        ...
        this.data = mainData.GetUIData(UIDataNameAvatar);
    ...
    private loadDefault() {
        ...
        this.data.menu = { menuItems: [], isVisible: false };
        this.data.entertainer = avatar.GetEntertainer(this);
    ...
    public AddChatEntertainer(avatar: IAvatar, text: string) {
        if (this.data.entertainer == null) return;
