import { IVideoLayerData, IVideoSettings, IVideoManagerData, IVideoSpriteProperties, X16SpriteModes, ISpritesData, IDragableElement, IMemoryDump }
...
export class VideoSpriteManager {
    ...
    public Parse(memDump: IMemoryDump, data: Uint8Array) {
        ...
        if (spData.selectedSpriteIndex == -1)
            spData.selectedSpriteIndex = 0;
    ...
    private ParseData(props: IVideoSpriteProperties, newData: Uint8Array): IVideoSpriteProperties {
        ...
        // end addrss
        props.SpriteEndAddress = props.SpriteAddress + props.Width * props.Height * (props.Bpp / 8);
        props.SpriteEndAddressHex = AsmTools.numToHex5(props.SpriteEndAddress);
