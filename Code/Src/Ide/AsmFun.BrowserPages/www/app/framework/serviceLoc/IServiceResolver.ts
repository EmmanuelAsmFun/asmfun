...
export interface IServiceResolver {
    ...
    export interface IServiceResolverFactory extends IServiceResolver, IDisposable {
        ...
        AddInstance<TService>(serviceName: ServiceName, service: TService, container?: string): IServiceSubscriptionT<TService>;
        Add<TService>(serviceName: ServiceName, type: { new(): TService }, container?: string): IServiceSubscriptionT<TService>;
        AddWithConstructor<TService>(serviceName: ServiceName, constructor1: Func1<Object, TService>, container?: string): IServiceSubscriptionT<TService>;
