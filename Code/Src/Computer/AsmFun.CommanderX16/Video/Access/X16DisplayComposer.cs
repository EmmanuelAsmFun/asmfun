...
namespace AsmFun.CommanderX16.Video
{
    ...
    /// </summary>
    public class X16DisplayComposer : DisplayComposerData 
    {
        ...
        public X16DisplayComposer(VideoSettings videoSettings, ComputerSetupSettings computerSetupSettings)
        {
        ...
        public void Init(IVideoPainter videoPainter)
        {
