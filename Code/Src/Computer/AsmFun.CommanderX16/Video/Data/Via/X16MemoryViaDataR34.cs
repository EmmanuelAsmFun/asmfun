...
{
    public class X16MemoryViaDataR34 : MemoryViaData, IMemoryViaData
    {
        ...
        public X16MemoryViaDataR34(IX16PS2Access ps2Data, X16JoystickData joyStickData, IComputerAccess computerAccess)
        {
                ...
                case 0:
                    {
                        ...
                        var value = ps2Data.GetValueForViaPB(via2reg2);
                        return value;
                    }
        ...
        public void write2(int register, int bank, byte value)
        {
            ...
            switch (register)
            {
                ...
                case 2:
                    ...
                    var via2reg2 = via2registers.ReadMemByte(2);
                    ps2Data.SetDataFromViaPB(via2reg0, via2reg2);
                    break;
                case 1:
                case 3:
                    {
